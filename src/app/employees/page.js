...
import { BarChart, Bar, XAxis, YAxis,Loader2, Tooltip, Legend, LineChart, Line, CartesianGrid } from 'recharts';
  ...
  useEffect(() => {
    ...
    const fetchProgressTask = async () => {
      try {
        ...
        toast.success(<span>Hello !😉 <br />Nous sommes ravis de vous revoir</span>);
