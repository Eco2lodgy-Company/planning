                                                ...
                                                <div className="space-y-3">
                                                    {dayReports.morning.length > 0 ? (
                                                        dayReports.morning.map((report) => (
                                                            ...
                                                            >
                                                                <div
                                                                    className="font-medium text-gray-900 mb-1 break-words whitespace-normal">
                                                                    {report.taches}
                                                                </div>
                                                                {report.blockage && (
                                                                    <div className="text-sm text-red-600 mb-1">
                                                                        <span
                                                                            className="font-medium">Blocage:</span> {report.blockage}
                                                                    </div>
                                                                )}
                                                                {report.solution && (
                                                                    <div className="text-sm text-green-600 mb-1">
                                                                        <span
                                                                            className="font-medium">Solution:</span> {report.solution}
                                                                    </div>
                                                                )}
